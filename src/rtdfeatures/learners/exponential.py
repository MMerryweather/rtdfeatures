"""Exponential parametric kernel learner."""
...
class ExponentialKernelLearner:
    """One-input/one-target constrained exponential parametric kernel learner."""
    ...
    def fit(
        ...
        *,
        ...
        def _forward_exponential() -> tuple[torch.Tensor, dict[str, torch.Tensor]]:
            rate_lambda = torch.nn.functional.softplus(raw_rate) + self._MIN_RATE_LAMBDA
            logits = -rate_lambda * lag_times
        ...
        best_loss, best_parameters, _best_weights = optimize_parametric_weights(
            ...
            forward=_forward_exponential,
            failure_message="Optimization failed to produce a valid exponential parameter fit.",
        )
        ...
        learned_kernel = _make_parametric_learned_kernel(
            ...
            min_lag_steps=prepared.min_lag_steps,
            max_lag_steps=prepared.max_lag_steps,
            parameters={"rate_lambda": best_rate_lambda},
        ...
        extra_provenance.update(
            build_parametric_fit_provenance(
                family="exponential",
                parameters={"rate_lambda": best_rate_lambda},
                initial_parameters={"rate_lambda": init_rate_lambda},
